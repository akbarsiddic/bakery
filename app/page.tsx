...
export function ButtonLocation() {
  return <Button>Find Location</Button>;
}
export default function Home() {
  return (
    <>
      <div className="bg-gradient-to-t from-orange-800 to-orange-600">
        {/* navbar for bakery website */}
        <nav className="sticky top-0 z-10 bg-orange-600 backdrop-filter backdrop-blur-lg bg-opacity-30 border-b border-orange-800">
        ...
        {/* hero section */}
        <section className="hero h-screen flex p-8 justify-between items-center ">
          <div className="hero-text text-left space-y-4">
            <h1 className="text-6xl font-bold">Fadiyo Bakery</h1>
            <p className="text-xl">Your Donut Heaven</p>
            <ButtonDemo />
          </div>
          <div>
            <Image src={Donut} alt="donut" width={500} height={500} />
          </div>
        </section>

        {/* About Fadiyo bakery */}
        <section className="about h-96 flex justify-center items-center p-4">
          <div className="about-text text-left">
            ...
            <div className="grid grid-cols-2 space-x-4 pt-4">
              <p className="text-xl text-white">
                Fadiyo Bakery is your ultimate destination for mouthwatering
                donut delights. We specialize in crafting unique and creative
                flavors to satisfy every sweet tooth.
              </p>
              <p className="text-xl text-white">
                Apart from donuts, we also offer a variety of other scrumptious
                food items. Indulge in our exceptional taste sensations and pair
                them with the perfect beverage for an unforgettable experience.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="p-24">
          <div className="flex flex-col justify-center items-center space-y-4 text-center">
            <h1 className="text-4xl font-bold text-white">Order Now</h1>
            <p className="text-xl text-white">Ready to experience the world of Fadiyo Bakery? Embark on your delicious donut journey today and explore the endless possibilities.</p>
